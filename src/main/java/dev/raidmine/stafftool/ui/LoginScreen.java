...
public final class LoginScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        UiTheme.text(context, textRenderer, "Авторизация персонала RaidMine", x + 0 + (panelW - UiTheme.textWidth("Авторизация персонала RaidMine", UiTheme.FONT_SIZE, false)) / 2, y + 157, UiTheme.MUTED);
        ...
        UiTheme.text(context, textRenderer, "Аккаунт", x + 58, y + 200, UiTheme.FAINT);
